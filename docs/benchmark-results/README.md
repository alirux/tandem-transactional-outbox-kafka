...
`2026-08-31-endurance-wakeup/` and `2026-08-31-outage-recovery/` differ: they ran on a different host
with different instruments, and name their own files in their READMEs.
